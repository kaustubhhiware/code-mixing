...
def final(tweetsCeleb, tweetsFollow):
  ...
  print('====================================Celebrities===================================='+'\n')
  utrCelebTop = printTop100(utrCeleb,1)
  uurCelebTop = printTop100(uurCeleb,2)
  uprCelebTop = printTop100(uprCeleb,3)
  print('\n\n\n')
  ...
  print('====================================Followers===================================='+'\n')
  utrFollowTop = printTop100(utrFollow,1)
  uurFollowTop = printTop100(uurFollow,2)
  uprFollowTop = printTop100(uprFollow,3)
